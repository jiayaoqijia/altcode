...
If the browse binary is available (Playwright MCP tools are available), visit the top 3-5 sites in the space and capture visual evidence:

```bash
# Use Playwright MCP browser_navigate to go to "https://example-site.com"
# Use Playwright MCP browser_take_screenshot for "/tmp/design-research-site-name.png"
